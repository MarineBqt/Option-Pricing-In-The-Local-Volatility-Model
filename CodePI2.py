...
########## #Modèle 1 : Pricer Volatilité Constante : on doit retrouver les prix de BS à t=0 ###########
# K=100
# Texp=1
# r=0.02
# q=0
...
########### Modèle 2 : Pricer Volatilité Constante ###########
# Texp=1
# S=100
# r=0.05
# q=0.02
...
########## Modèle 2 : Pricer Volatilité Non Constante : on doit retrouver les prix de marché à t=0 ###########
expiration_date="2023-08-18"
K=[365,370,375,380,385,390,395,400,405,410,415,420,425,430,435]
Ntime=50 
Mspace=100
r=0.02  #taux sans risque obligation sur yahoo
q=0
epsilon=20 #à jouer avec 
...
#Spot
S=Market_Importation("SPY", K, expiration_date)[1]
...
#Market Price
C_Market=Market_Importation("SPY", K, expiration_date)[0]
...
plt.title("Model Implied Volatility")
plt.show()
